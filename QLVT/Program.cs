...
namespace QLVT
{
    static class Program
    {
        ...
        public static String connstrPublisher = "Data Source=DESKTOP-AQ0OIVA;Initial Catalog=QLVT_DATHANG;Integrated Security=true";
        public static SqlDataReader myReader;//myReader


        //servername: tên server(phân mảnh) sẽ kết nối tới
        //    servername: tên server(phân mảnh) sẽ kết nối tớ
        ...
        //các biến cho chức năng in báo cáo hoạt động nhân viên -> lưu trữ giá trị hiệnthời
        ...
        // tạo form xong mở command trong này ra -> vì các biến form
